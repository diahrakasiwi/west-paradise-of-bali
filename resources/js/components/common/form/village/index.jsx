            ...
            <Card style={{ borderRadius: 10 }}>
                ...
                >
                    <Row gutter={16}>
                        <Col span={24}>
                            <Form.Item
                                label="Nama Desa Desa"
                                name="name"
                                rules={[
                                    {
                                        required: true,
                                        message: "Masukkan nama desa wisata",
                                    },
                                ]}
                            >
                                <Input placeholder="Masukkan Nama Desa Wisata..." />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item
                    ...
                    <Form.Item name="is_fullday" valuePropName="checked">
                        ...
                        >
                            ...
                            <Text italic type="secondary">
                                * Centang jika Desa Wisata beroperasi 24
                                Jam.
                            </Text>
                        </Checkbox>
                    </Form.Item>
                    ...
                    <Form.Item name="is_published" valuePropName="checked">
                        <Checkbox>
                            Publish{" "}
                            <Text italic type="secondary">
                                * Centang jika Desa Wisata dipublish.
                            </Text>
                        </Checkbox>
                    </Form.Item>
