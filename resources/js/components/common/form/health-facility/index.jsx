...
export default function FormHealthFacility({
    onSubmit,
    onCancel,
    process,
    initialValues,
                ...
                >
                    <Row gutter={16}>
                        <Col span={24}>
                            ...
                            >
                                <Input placeholder="Masukkan Nama Fasilitas Kesehatan..." />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item
                    ...
                    <Form.Item name="is_fullday" valuePropName="checked">
                        ...
                        >
                            ...
                            <Text italic type="secondary">
                                * Centang jika Fasilitas Kesehatan beroperasi 24
                                Jam.
                            </Text>
                        </Checkbox>
                    </Form.Item>
                    ...
                    <Form.Item name="is_published" valuePropName="checked">
                        <Checkbox>
                            Publish{" "}
                            <Text italic type="secondary">
                                * Centang jika Fasilitas Kesehatan dipublish.
                            </Text>
                        </Checkbox>
                    </Form.Item>
