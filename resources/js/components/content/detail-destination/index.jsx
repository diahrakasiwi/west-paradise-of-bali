...
export default function DetailDestinationContent() {
    ...
    const position = [parseFloat(data.latitude), parseFloat(data.longitude)]; //tambah
            ...
            >
                ...
                >
                    <Button
                        ...
                        onClick={() => Inertia.visit(`/destination/?lang=${locale}&type=${type}`)}
                        style={{ color: "white" }}
                    />
                    <span
                        style={{
                    ...
                    <Col xs={24} lg={16}>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Paragraph>
                                    <ClockCircleOutlined style={{ color: "#E81E4B" }} />{" "}
                                    {data.is_fullday === "1"
                                        ? "24 Jam"
