...
Route::post('/dashboard/health-facilities', [HealthFacilityController::class, 'store'])->middleware('auth');
Route::get('/dashboard/health-facilities/{id}/edit', [HealthFacilityController::class, 'edit'])->middleware('auth');
